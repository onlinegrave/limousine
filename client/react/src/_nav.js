...
const _nav = [
  ...
  },
  {
    ...
    anchor: 'Orders',
    to: '/orders',
    icon: <CIcon name="cil-list" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
    as: NavLink,
    anchor: 'Order Histories',
    to: '/order-histories',
    icon: <CIcon name="cil-hwistory" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
    as: NavLink,
    anchor: 'Map',
    to: '/map',
    icon: <CIcon name="cib-openstreetmap" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
    as: NavLink,
    anchor: 'Messengers',
    to: '/messengers',
    icon: <CIcon name="cib-messenger" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
    as: NavLink,
    anchor: 'Companies',
    to: '/companies',
    icon: <CIcon name="cil-building" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
    as: NavLink,
  ...
  },
  {
    ...
    anchor: 'Vehicles',
    to: '/vehicles',
    icon: <CIcon name="cil-car-alt" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
    as: NavLink,
  ...
  },
  {
    _component: 'CNavItem',
    as: NavLink,
    anchor: 'Order Imports',
    to: '/order-imports',
    icon: <CIcon name="cil-cloud-download" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
    as: NavLink,
    anchor: 'Hotel Order Imports',
    to: '/hotel-order-imports',
    icon: <CIcon name="cil-cloud-download" customClasses="nav-icon" />,
  },
  {
    _component: 'CNavItem',
