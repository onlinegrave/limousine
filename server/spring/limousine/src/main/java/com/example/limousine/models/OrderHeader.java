...
public class OrderHeader {
  ...
  @Id
  @Embedded
  private OrderHeaderId orderHeaderId;
  ...
  @Embeddable
  @Data
  public static class OrderHeaderId implements Serializable {
    private static final long serialVersionUID = 223372036854778877L;

    public OrderHeaderId(String companyId, Long orderId, Integer version) {
